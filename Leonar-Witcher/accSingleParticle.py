...
def compute_retarded(points, t, ps, vs, chunk_size=1000):
    """
...
def update_field(t):
    ...
    if do_poynting:  
        ...
        pdata['col_el'] = magnitudes_el / np.max(magnitudes_el) * 255.0
        pdata['col_mag'] = magnitudes_mag / np.max(magnitudes_mag) * 255.0
